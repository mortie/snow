...
IRC channel: [#snow on Freenode](irc://irc.freenode.net/snow:)
([web client](http://webchat.freenode.net?channels=snow)). If you have any
questions, or just want to chat, just ping me (@mort) :)
